...
// Ver Linux: \linux-2.6.11.6\include\linux\if.h  por contenido a definir
  ...
  Queue sendQueue;     // Cola de frames a enviar, accedida por Link
  Semaphore LinkTieneTarea;
private Link link;
  ...
  public Interface(String nm, IpAddress addr, Mask msk, Integer mtu /*,Link k*/ ) throws NodeException {
    ...
    netMask = msk;
    MTU = mtu;
    LinkTieneTarea = new Semaphore(0);
  ...
  public void receive(byte[]b) {
    ...
    switch (proto) {
      case NetworkProtocols.PROTO_IP:
        ...
        n = new N2N3Indication(N2N3Indication.FRAME_RECEIVED, rec, this);
...
public Semaphore getHayTarea() {
	return LinkTieneTarea;
}
