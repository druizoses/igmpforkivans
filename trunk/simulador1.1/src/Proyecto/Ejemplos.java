...
public class Ejemplos
{
    ...
    private static void prueba(){
        ...
        System.out.println("\n4. Envio de un datagrama sin fragmentacion a un destino existente en la misma red a traves de un Switch");
        ...
        try
        {
           ...
           // PC4
           Equipo pc4=LocalizadorEquipos.New("Ordenador","PC4");
           // PC5
           Equipo pc5=LocalizadorEquipos.New("Ordenador","PC5");
           // PC6
           Equipo pc6=LocalizadorEquipos.New("Ordenador","PC6");
           // Router1
           Equipo router1=LocalizadorEquipos.New("Router", "Router1");
           // Router2
           Equipo router2=LocalizadorEquipos.New("Router", "Router2");
           // Switch1
           Equipo switch1=LocalizadorEquipos.New("Switch", "Switch1");
           // Switch2
           Equipo switch2=LocalizadorEquipos.New("Switch", "Switch2");
           
           /*interfaz=LocalizadorRedes.NewInterfaz("eth0","10.1.0.1","255.255.0.0","00:00:00:00:00:01","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           pc1.setInterfaz(interfaz);*/
           
           /*interfaz=LocalizadorRedes.NewInterfaz("eth1","10.1.0.2","255.255.0.0","00:00:00:00:00:02","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           pc2.setInterfaz(interfaz);*/
           
           interfaz=LocalizadorRedes.NewInterfaz("eth0","0.0.0.0","0.0.0.0","00:00:00:00:00:00","Ethernet.Ethernet");
           interfaz.Conectar(pc1, "eth0;10.1.0.1;255.255.0.0;00:00:00:00:00:01;Ethernet.Ethernet");
           switch1.setInterfaz(interfaz);
           
           interfaz=LocalizadorRedes.NewInterfaz("eth1","0.0.0.0","0.0.0.0","00:00:00:00:00:00","Ethernet.Ethernet");
           interfaz.Conectar(pc2, "eth0;10.1.0.2;255.255.0.0;00:00:00:00:00:02;Ethernet.Ethernet");
           switch1.setInterfaz(interfaz);
           
           interfaz=LocalizadorRedes.NewInterfaz("eth2","10.1.0.1","255.255.0.0","00:00:00:00:00:01","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           switch1.setInterfaz(interfaz);
           
           pc1.tablaDeRutas.Anadir("10.1.0.0","255.255.0.0","0.0.0.0",new DireccionIPv4("10.1.0.1"));
           pc1.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.1.0.10",new DireccionIPv4("10.1.0.1"));
           
           pc2.tablaDeRutas.Anadir("10.1.0.0","255.255.0.0","0.0.0.0",new DireccionIPv4("10.1.0.2"));
           pc2.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.1.0.10",new DireccionIPv4("10.1.0.2"));
           
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.1.0.3","255.255.0.0","00:00:00:00:00:03","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           pc3.setInterfaz(interfaz);
           pc3.tablaDeRutas.Anadir("10.1.0.0","255.255.0.0","0.0.0.0",new DireccionIPv4("10.1.0.3"));
           pc3.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.1.0.10",new DireccionIPv4("10.1.0.3"));
           
           /*interfaz=LocalizadorRedes.NewInterfaz("eth0","10.2.1.1","255.255.0.0","00:00:00:00:00:04","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           pc4.setInterfaz(interfaz);*/          

           /*interfaz=LocalizadorRedes.NewInterfaz("eth0","10.2.1.2","255.255.0.0","00:00:00:00:00:05","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           pc5.setInterfaz(interfaz);*/
           
           interfaz=LocalizadorRedes.NewInterfaz("eth0","0.0.0.0","0.0.0.0","00:00:00:00:00:00","Ethernet.Ethernet");
           interfaz.Conectar(pc4, "eth0;10.2.1.1;255.255.0.0;00:00:00:00:00:04;Ethernet.Ethernet");
           switch2.setInterfaz(interfaz);
           
           interfaz=LocalizadorRedes.NewInterfaz("eth1","0.0.0.0","0.0.0.0","00:00:00:00:00:00","Ethernet.Ethernet");
           interfaz.Conectar(pc5, "eth0;10.2.1.2;255.255.0.0;00:00:00:00:00:05;Ethernet.Ethernet");
           switch2.setInterfaz(interfaz);
           
           interfaz=LocalizadorRedes.NewInterfaz("eth2","0.0.0.0","0.0.0.0","00:00:00:00:00:00","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           switch2.setInterfaz(interfaz);
           
           pc4.tablaDeRutas.Anadir("10.2.1.0","255.255.0.0","0.0.0.0",new DireccionIPv4("10.2.1.1"));
           pc4.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.2.1.10",new DireccionIPv4("10.2.1.1"));
           
           pc5.tablaDeRutas.Anadir("10.2.1.0","255.255.0.0","0.0.0.0",new DireccionIPv4("10.2.1.2"));
           pc5.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.2.1.10",new DireccionIPv4("10.2.1.2"));
           
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.2.1.3","255.255.0.0","00:00:00:00:00:06","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           pc6.setInterfaz(interfaz);
           pc6.tablaDeRutas.Anadir("10.2.1.0","255.255.0.0","0.0.0.0","eth0");
           pc6.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.2.1.10","eth0");

           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.1.0.10","255.255.0.0","00:00:00:00:00:07","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           router1.setInterfaz(interfaz);
           interfaz=LocalizadorRedes.NewInterfaz("eth1","10.2.1.10","255.255.0.0","00:00:00:00:00:08","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           router1.setInterfaz(interfaz);
           router1.tablaDeRutas.Anadir("10.1.0.0","255.255.0.0","0.0.0.0","eth0");
           router1.tablaDeRutas.Anadir("10.2.1.0","255.255.0.0","0.0.0.0","eth1");
           router1.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.2.1.11","eth0");
           
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.1.0.11","255.255.0.0","00:00:00:00:00:09","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           router2.setInterfaz(interfaz);
           interfaz=LocalizadorRedes.NewInterfaz("eth1","10.2.1.11","255.255.0.0","00:00:00:00:00:10","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           router2.setInterfaz(interfaz);
           router2.tablaDeRutas.Anadir("10.1.0.0","255.255.0.0","0.0.0.0","eth0");
           router2.tablaDeRutas.Anadir("10.2.1.0","255.255.0.0","0.0.0.0","eth1");
           router2.tablaDeRutas.Anadir("0.0.0.0","255.255.255.255","10.1.0.10","eth0");
           ...
           simulador.NuevoEquipo(pc4);
           simulador.NuevoEquipo(pc5);
           simulador.NuevoEquipo(pc6);
           simulador.NuevoEquipo(router1);
           simulador.NuevoEquipo(router2);
           simulador.NuevoEquipo(switch1);
           simulador.NuevoEquipo(switch2);
           ...
           dato.direccion=new DireccionIPv4("10.2.255.255");
           dato.protocolo=0;
           ...
           pc4.SimularError(Equipo.kICMP,"IGNORAR_ICMP_3_2",true);
           pc5.SimularError(Equipo.kICMP,"IGNORAR_ICMP_3_2",true);
           pc6.SimularError(Equipo.kICMP,"IGNORAR_ICMP_3_2",true);
           router1.SimularError(Equipo.kICMP,"IGNORAR_ICMP_3_2",true);
           router2.SimularError(Equipo.kICMP,"IGNORAR_ICMP_3_2",true);
    ...
    private static void Simulacion(){
        ...
        try
        {
           ...
           Red ethernet4=LocalizadorRedes.New("Ethernet.Ethernet","ethernet4");
           ...
           // PC4
           Equipo pc4=LocalizadorEquipos.New("Ordenador","PC4");
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.4","255.255.255.0","00:00:00:00:00:04","Ethernet.Ethernet");
           interfaz.Conectar(ethernet3);
           pc4.setInterfaz(interfaz);
           pc4.tablaDeRutas.Anadir("10.0.1.0","255.255.255.0","directa",new DireccionIPv4("10.0.1.4"));
           ...
           // Switch
           Equipo Switch=LocalizadorEquipos.New("Switch","Puente");
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.3","255.255.255.0","00:00:00:00:00:06","Ethernet.Ethernet");
           interfaz.Conectar(ethernet1);
           Switch.setInterfaz(interfaz);
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.3","255.255.255.0","00:00:00:00:00:07","Ethernet.Ethernet");
           interfaz.Conectar(ethernet2);
           Switch.setInterfaz(interfaz);
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.3","255.255.255.0","00:00:00:00:00:08","Ethernet.Ethernet");
           interfaz.Conectar(ethernet3);
           Switch.setInterfaz(interfaz);
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.3","255.255.255.0","00:00:00:00:00:09","Ethernet.Ethernet");
           interfaz.Conectar(ethernet4);
           Switch.setInterfaz(interfaz);  
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.5","255.255.255.0","00:00:00:00:00:05","Ethernet.Ethernet");
           interfaz.Conectar(Switch, "eth0;10.0.1.6;255.255.255.0;00:00:00:00:00:10;Ethernet.Ethernet");
           pc5.setInterfaz(interfaz);
           pc5.tablaDeRutas.Anadir("10.0.1.0","255.255.255.0","directa",new DireccionIPv4("10.0.1.5"));
           
           Equipo Switch2=LocalizadorEquipos.New("Switch","Puente2");
           interfaz=LocalizadorRedes.NewInterfaz("eth3","10.0.1.3","255.255.255.0","00:00:00:00:00:14","Ethernet.Ethernet");
           interfaz.Conectar(ethernet4);
           Switch2.setInterfaz(interfaz);  
           interfaz=LocalizadorRedes.NewInterfaz("eth0","10.0.1.7","255.255.255.0","00:00:00:00:00:15","Ethernet.Ethernet");
           interfaz.Conectar(Switch2, "eth0;10.0.1.6;255.255.255.0;00:00:00:00:00:16;Ethernet.Ethernet");
           pc6.setInterfaz(interfaz);
           pc6.tablaDeRutas.Anadir("10.0.1.0","255.255.255.0","directa",new DireccionIPv4("10.0.1.7"));
           ...
           for(int k=0;k<buffer.Tam();k++)
              buffer.setByte(k,k%255);
           Dato dato=new Dato(0,buffer);
           Dato dato2=new Dato(0,buffer);
           dato.direccion=new DireccionIPv4("10.0.1.255");
           dato.protocolo=0;
           dato2.direccion=new DireccionIPv4("10.0.1.1");
           dato2.protocolo=0;
        
           //pc1.ProgramarSalida(dato);  
           pc5.ProgramarSalida(dato);
