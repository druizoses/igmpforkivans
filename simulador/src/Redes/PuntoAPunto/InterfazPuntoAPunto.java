 ...
 */
public class InterfazPuntoAPunto extends Interfaz 
{
	/**
	 * Constructor
	 ...
	 */
    public InterfazPuntoAPunto(String nombre,String ip,String mascara,String dirEnlace) throws IllegalArgumentException
	{
		super(nombre,ip,mascara);
		
		parametros.add(new Parametro("dirfisica","Dirección Física","Redes.PuntoAPunto.DireccionPuntoAPunto"));
		parametros.setValor("dirfisica",new DireccionPuntoAPunto(dirEnlace));
		parametros.add(new Parametro("clasered","Paquete de redes compatibles","java.lang.String"));
		parametros.setValor("clasered","PuntoAPunto");
	...
	public void CreaNivelEnlace(Equipo equipo)
	{
		...
		if(equipo!=null && red!=null && getDirFisica()!=null)
		   this.nivelEnlace=new NivelPuntoAPunto(equipo,red,(DireccionPuntoAPunto)getDirFisica());
		else
